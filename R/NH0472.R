#' Conjunto de datos de NH0472
#'
#' Este conjunto de datos contiene información meteorológica específica para la estación NH0046.
#'
#' @format Un data frame con 20425 filas y 35 columnas:
#' \describe{
#'   \item{ID}{ID de la estacion}
#'   \item{fecha}{Fecha de la obtencion de los datos}
...
#' }
#' @source Fuente de los datos o descripción de cómo se obtuvieron.
"NH0472"
