#' Conjunto de datos meteorologicos "NH0910"
#'
#' Los datos son utilizados para diferentes funciones dentro del paquete
#'
#' @format conjunto de datos con 15,553 filas y 35 columnas
#' \describe{
#'  \item{id}{ID de la estacion a descargar}
#'  \item{fecha}{fecha en la cual se recolectaron los datos}
#'  \item{temperatura_abrigo_150cm}{temperatura medida a 150cm}
#'  \item{temperatura_abrigo_150cm_maxima}{temperatura maxima a 150cm}
#'  \item{temperatura_abrigo_150cm_minima}{temperatura minima a 150cm}
